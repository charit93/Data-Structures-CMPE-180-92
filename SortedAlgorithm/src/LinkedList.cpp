...
void LinkedList::split(LinkedList& list1, LinkedList& list2) //Split this list into two sublists.
{
	int list_size = size;

	for (int i = 0; i < list_size; i++)
	{
		//Move the element in the even index number in one list
		if ( i % 2 == 0)
...
void LinkedList::concatenate(LinkedList& other_list) // Add another list to the end of this list.
{
